...
func SignLindell(m string, pub *PaillierPub, priv *PaillierPriv, x_a, x_b, x_b_enc, X_x, X_y, k_a, k_b *big.Int, attack bool, l, y_b *big.Int) bool {
	...
	verifies := ecdsa.Verify(X, m_hash[:], R_x, s)
